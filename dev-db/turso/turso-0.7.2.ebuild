...
# source URI, build target (turso_cli) and install adapted for the workspace.
...
CRATES="
	...
	codspeed-divan-compat-macros@4.6.0
	codspeed-divan-compat-walltime@4.6.0
	codspeed-divan-compat@4.6.0
	codspeed@4.6.0
	colorchoice@1.0.3
	colored@2.2.0
	combine@4.6.7
...
DESCRIPTION="SQLite-compatible in-process SQL database in Rust (tursodb CLI)"
HOMEPAGE="https://github.com/tursodatabase/turso"
SRC_URI="
	https://github.com/tursodatabase/turso/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
LICENSE+="
	...
	CC0-1.0 CDDL CDLA-Permissive-2.0 ISC MIT MPL-2.0 MPL-2.0 Unicode-3.0
	ZLIB
"
SLOT="0"
KEYWORDS="~amd64"
...
src_compile() {
	...
	# bindings and perf/test crates that need external toolchains we don't want.
	cargo_src_compile -p turso_cli
}

src_install() {
	dobin "$(cargo_target_dir)"/tursodb
