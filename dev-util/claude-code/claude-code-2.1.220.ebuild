...
SLOT="0"
# Overlay bump ahead of ::gentoo (which stops at 2.1.211). The Manifest covers all
# four upstream binaries (amd64/arm64 x glibc/musl), but only ~amd64 is keyworded
# here since that is the only variant tested end-to-end on this host; a host that
# can verify arm64 may add ~arm64.
KEYWORDS="~amd64"
